...
##             [Brick(v=20), Blank(), Blank(), Blank(8), Brick(h=14), Blank(), Blank()],
##             [Brick(v=8), Blank(), Blank(), Brick(h=17), Blank(), Blank(), Blank()]]
...
#niva1
##    board = [[Brick(),      Brick(v=16),    Brick(v=17),        Brick(),            Brick(v=13),    Brick(v=14)],
##             [Brick(h=16),  Blank(),        Blank(),            Brick(v=14,h=16),   Blank(),        Blank()],
##             [Brick(h=35),  Blank(),        Blank(),            Blank(),            Blank(),        Blank()],
##             [Brick(),      Brick(v=13),    Brick(v=15,h=5),    Blank(),            Brick(v=4),     Brick(v=8)],
##             [Brick(h=22),  Blank(),        Blank(),            Blank(),            Blank(),        Blank()],
##             [Brick(h=17),  Blank(),        Blank(),            Brick(h=3),         Blank(),        Blank()]]
             
             
    #board=[[Brick(h=18),Blank(),Blank()]]


#3x3 ok
##    board=[[Brick(),Brick(v=12),Brick(v=8)],
##           [Brick(h=14),Blank(),Blank()],
##           [Brick(h=6),Blank(),Blank()]]


#4x4 ok 
##    board=[[Brick(),Brick(v=24),Brick(v=12),Brick(v=10)],
##           [Brick(h=23),Blank(),Blank(),Blank()],
##           [Brick(h=13),Blank(),Blank(),Blank()],
##           [Brick(h=10),Blank(),Blank(),Blank()]]



#hard \ok

##    board=[[Brick(),      Brick(),            Brick(v=21),    Brick(v=17),        Brick(v=35),     Brick()],
##             [Brick(),      Brick(v=24,h=21),   Blank(),        Blank(),            Blank(),         Brick(v=10)],
##             [Brick(h=32),  Blank(),            Blank(),        Blank(),            Blank(),         Blank()],
##             [Brick(h=12),  Blank(),            Blank(),        Brick(v=3,h=16),    Blank(),         Blank()],
##             [Brick(h=19),  Blank(),            Blank(),        Blank(),            Blank(),         Blank()],
##             [Brick(),      Brick(h=10),        Blank(),        Blank(),            Blank(),         Brick()]]
...
##    board=[[Brick(),        Brick(),            Brick(v=30),Brick(v=23)],
##           [Brick(),        Brick(h=12),        Blank(),    Blank()],
##           [Brick(),        Brick(v=12,h=16),   Blank(),    Blank()],
##           [Brick(h=11),    Blank(),            Blank(),    Blank()],
##           [Brick(h=12),    Blank(),            Blank(),    Brick()],
##           [Brick(h=14),    Blank(),            Blank(),    Brick()]]


#ok pour version mini
##    board=[[Brick(),        Brick(),            Brick(),Brick(v=23)],
##           [Brick(),        Brick(h=12),        Blank(),    Blank()],
##           [Brick(),        Brick(h=16),   Blank(),    Blank()],
##           [Brick(h=11),    Blank(),            Blank(),    Blank()]]
##          
